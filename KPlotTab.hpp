...
public:
    ...
    bool delete_gaph(int idx);
    bool delete_gaph(std::string title);
    KGraph& get_graph(int idx, bool& success);
    KGraph& get_graph(std::string title, bool& success);
    ...
    //Draw tab
    void draw_tab(sf::RenderWindow window, int left_bound, int right_bound, int top_bound, int low_bound, int window_style);
